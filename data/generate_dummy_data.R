...
write.table(genotype, file = here::here("./data/", "grouped_genotype.tsv"), sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)
write.table(discrete_phenotype, file = "./data/discrete_phenotype.tsv", sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)
write.table(continuous_phenotype, file = "./data/continuous_phenotype.tsv", sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)
write.table(snp_gene_key, file = "./data/snp_gene_key.tsv", sep = "\t", quote = FALSE, row.names = TRUE, col.names = TRUE)
