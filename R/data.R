...
#' @format A matrix with 7 rows and 1 columns. Each row name corresponds to a tree tip.
#' \describe{
#'   \item{resistance}{Antibiotic resistance encoded as 1; antibiotic susceptible encoded as 0}
#'  }
...
#' @format A matrix with 7 rows and 8 columns. Rows correspond to isolates and tree tips. Columns correspond to genotypes.
#' \describe{
